...
These classes are proven to transfer and satisfy credit for the Associate's degree (That you will bypass using the BitC Curriculum)
...
These are recommended as the core for all tracks you take. These lay the foundation for understanding critical reading , writing and thinking, and epistemology...that is the knowledge of learning itself. 
This will be the foundations to develop skills as an adaptive and dynamic individual.
